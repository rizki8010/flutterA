      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // Total Price and Request Button
            if (selectedPrices.isNotEmpty) ...[
              // Menampilkan total harga yang dipilih
              Text(
              ...
              ElevatedButton(
                onPressed: () {
                  if (selectedPrices.isNotEmpty) {
                    // Navigasi langsung ke halaman ContractSigningPage
                    Navigator.pushNamed(
                      context,
                      '/contractSigning',
                      arguments: {
                    ...
                    // Tampilkan pesan jika tidak ada harga yang dipilih
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          'Pilih satu atau lebih item terlebih dahulu',
                        ),
                      ),
                    );
                  }
